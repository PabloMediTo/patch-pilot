 ...
 *
 * @param {{ environment: object, githubWebhook: object, reviewStore: object, timelineStore: object, approvalStore: object, timelineStream: object, clock?: Function, scheduleHeartbeat?: Function, maxBodyBytes?: number }} options Deployment values and persisted evidence ports.
...
export function createMaintainerApiRuntime(options) {
  ...
  const server = createMaintainerApiServer({ authentication,
    ...
    approval: { loadApprovalState: reviewQuery.loadApprovalState,
      saveFirstDecision: options.approvalStore.saveFirstDecision, clock: options.clock },
