...
- The API shell now owns a concrete Node listener and dispatcher for review evidence, approval, and timeline SSE, including bounded JSON/form parsing and heartbeat scheduling. Authentication and persistence remain injected until API main-process composition.
