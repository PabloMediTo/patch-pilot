...
- No Temporal workflow, concrete GitHub API adapter, HTTP listener/composition root, visual frontend, dependency restoration, or worker-owned Docker CLI process port has been implemented.
