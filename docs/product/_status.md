...
- No Temporal workflow, concrete GitHub API adapter, HTTP listener/composition root, visual frontend, dependency restoration, or container command sandbox has been implemented.
