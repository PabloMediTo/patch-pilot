...
- No Temporal workflow, concrete GitHub API adapter, HTTP listener/composition root, visual frontend, dependency restoration, or worker composition of the sandbox adapter and Docker CLI port has been implemented.
