...
- owning the run-persistence schema or scheduling Temporal workflows
...
- [run persistence](run-persistence.md) atomically records accepted submissions through the executable API deployment before the future Temporal adapter starts work
