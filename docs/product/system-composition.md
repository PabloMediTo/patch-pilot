...
| Web interface | Present run submission, timeline, diff, evidence, and approval controls | Running tools or publishing changes | API query data and live events | Run requests and approval decisions | Control-plane API |
